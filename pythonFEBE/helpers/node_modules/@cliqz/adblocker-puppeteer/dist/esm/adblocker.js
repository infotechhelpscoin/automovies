...
import { DOMMonitor, extractFeaturesFromDOM, autoRemoveScript } from '@cliqz/adblocker-content';
 ...
 */
class PuppeteerBlocker extends FiltersEngine {
    constructor() {
        super(...arguments);
...
export { BlockingContext, PuppeteerBlocker, fromPuppeteerDetails };
